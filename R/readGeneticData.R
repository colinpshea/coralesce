...
#' `readGeneticData(fileloc = paste0(getwd(),"/Data/", paste0(list.files(paste0(getwd(),"/Data/")))))` if the genetics data are located (as they should be) in a working directory folder called `Data`.
#' 
